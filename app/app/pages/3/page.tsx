    ...
    <div className="slide-container relative w-full min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-700 flex flex-col">
      ...
      <div className="flex-none text-center py-4 md:py-6">
        <div className="flex items-center justify-center space-x-4 mb-2 md:mb-3">
          <Shield size={48} className="md:w-16 md:h-16 text-yellow-400" />
          <h1 className="text-2xl md:text-4xl lg:text-6xl font-bold text-yellow-400">SAFETY FIRST</h1>
        </div>
        <p className="text-2xl md:text-3xl lg:text-4xl text-gray-200">Zero Incidents Through Proactive Prevention</p>
      </div>

      {/* Main Content */}
      <div className="flex-1 grid grid-cols-2 gap-4 md:gap-6 lg:gap-8 px-4 md:px-6 lg:px-8">
        {/* Column 1: Frontline Responsibilities */}
        <div className="bg-gray-800 bg-opacity-60 backdrop-blur border-l-4 border-yellow-400 rounded-lg p-4 md:p-5 lg:p-6">
          <div className="flex items-center space-x-3 mb-2 md:mb-3">
            <Users size={24} className="md:w-7 md:h-7 text-yellow-400" />
            <h3 className="text-lg md:text-xl lg:text-2xl font-bold text-white">FRONTLINE RESPONSIBILITIES</h3>
          </div>
          ...
          <div className="bg-yellow-500 bg-opacity-10 border border-yellow-500 border-opacity-30 rounded-lg p-3 md:p-4">
            <h4 className="text-base md:text-lg font-bold text-yellow-400 mb-2">SUCCESS METRICS</h4>
        ...
        <div className="bg-gray-800 bg-opacity-60 backdrop-blur border-l-4 border-yellow-400 rounded-lg p-4 md:p-5 lg:p-6">
          <div className="flex items-center space-x-3 mb-2 md:mb-3">
            <Shield size={24} className="md:w-7 md:h-7 text-yellow-400" />
            <h3 className="text-lg md:text-xl lg:text-2xl font-bold text-white">SPECIFIC OPERATOR ACTIONS</h3>
          </div>
          ...
          <div className="bg-yellow-500 bg-opacity-10 border border-yellow-500 border-opacity-30 rounded-lg p-2 md:p-3 mb-2">
            <h4 className="text-sm md:text-base font-bold text-yellow-400 mb-1">FOCUS AREAS</h4>
            <div className="space-y-1">
              <p className="text-sm text-gray-300">• Safety system effectiveness • Team engagement metrics • Continuous improvement culture</p>
            </div>
          </div>

          <div className="bg-yellow-500 bg-opacity-20 border border-yellow-500 border-opacity-50 rounded-lg p-2 md:p-3">
