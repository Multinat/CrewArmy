    ...
    <div className="slide-container relative w-full min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-700 flex flex-col">
      ...
      <div className="flex items-center justify-center">
        <div className="flex items-center gap-2 md:gap-4">
          <CheckCircle className="h-6 w-6 md:h-8 md:w-8 lg:h-10 lg:w-10 text-green-400" />
          <h1 className="text-xl md:text-3xl lg:text-5xl font-bold text-center">
            QUALITY ALWAYS - Right First Time Through Continuous Excellence
          </h1>
        </div>
      </div>
      ...
      <div className="flex-1 grid grid-cols-2 gap-4 px-4">
        ...
        <div className="bg-gray-800 bg-opacity-60 backdrop-blur border-l-4 border-green-400 rounded-lg p-4 flex flex-col min-h-0">
          ...
          <div className="bg-green-500 bg-opacity-10 border border-green-500 border-opacity-30 rounded-lg p-3">
            <h4 className="text-base font-bold text-green-400 mb-2">SUCCESS METRICS</h4>
        ...
        <div className="bg-gray-800 bg-opacity-60 backdrop-blur border-l-4 border-green-400 rounded-lg p-4 flex flex-col min-h-0">
          <div className="flex items-center space-x-3 mb-2">
            <Cog size={28} className="text-green-400" />
